package com.javacodingskill.spring.batch.example5.multistepjob.runner;
...
import com.javacodingskill.spring.batch.example5.multistepjob.utils.Constants;
...
public class JobRunner {
	...
	/*
	 * @Autowired public JobRunner(Job demo1, JobLauncher jobLauncher) {
	 * this.simpleJobLauncher = jobLauncher; this.demo1 = demo1; }
	 */
	...
	public void runBatchJob() {
		...
		this.runJob(demo1, jobParametersBuilder.toJobParameters());
	}
