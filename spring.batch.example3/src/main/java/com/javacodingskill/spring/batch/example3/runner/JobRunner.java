package com.javacodingskill.spring.batch.example3.runner;
...
import com.javacodingskill.spring.batch.example3.utils.Constants;
...
public class JobRunner {
	...
	public void runBatchJob() {
		...
		this.runJob(demo3, jobParametersBuilder.toJobParameters());
	}
